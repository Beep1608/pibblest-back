...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // 2. ¿Qué métodos permitimos? (El OPTIONS es VITAL para que no falle el
        // preflight)
        configuration.setAllowedMethods(Arrays.asList("GET", "POST", "PUT", "DELETE", "OPTIONS"));

        // 3. ¿Qué headers permitimos?
        // Como vi que tienes un "tenantFilter", seguramente mandas un header de tenant,
        // asegúrate de agregarlo aquí si es así.
