...
public class TagService {
    ...
    public TagService(TagRepository tagRepository, StoreRepository storeRepository, MessageSource messageSource, StoreTagRepository storeTagRepository){
    ...
    public ResponseEntity<CreateTagResponse> createTag(@Valid @RequestBody CreateTagRequest request){
        ...
        tagRepository.save(tagEntityRequest);

       CreateTagResponse response = new CreateTagResponse(tagRepository.findAll());
