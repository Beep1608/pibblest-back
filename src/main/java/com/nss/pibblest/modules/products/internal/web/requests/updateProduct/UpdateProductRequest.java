...
public class UpdateProductRequest {
    ...
    public UpdateProductRequest(String name, String sku, String barcode, String description, String brand, BigDecimal basePrice, BigDecimal cost, Long quantity, Set<Long> tagsId) {
        this.name = name;
        this.sku = sku;
